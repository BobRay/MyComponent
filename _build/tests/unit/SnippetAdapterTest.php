...
class SnippetAdapterTest extends \Codeception\Test\Unit {
    public string $objectName = 'snippets';
    public string $baseClass = 'modSnippet';
    public string $adapter = 'SnippetAdapter';
    ...
    protected function _before(): void {
        ...
        foreach ($objects as $key => $fields) {
            ...
            $codeFile = $this->elementCodeBase . $this->objectName . '/' . $name . '.' . $type . $this->codeFileSuffix;
            $codeFile = strtolower($codeFile);

            if (file_exists($codeFile)) {
                assertNotFalse(unlink($codeFile));
            }
        }
    }
