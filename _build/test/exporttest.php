...
class ExportTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->export = new MyComponentProject($modx);
        $this->modx =& $this->export->modx;
        /* @var $categoryObj modCategory */
        $this->export->init(array(), 'unittest');
    ...
    public function testInit()
    {
        ...
        $this->modx->log(MODX::LOG_LEVEL_INFO, 'Target Root: ' . PHPUnit_Framework_Assert::readAttribute($this->export, 'targetRoot'));
        $this->modx->log(MODx::LOG_LEVEL_INFO, 'TargetCore: ' . $this->export->myPaths['targetCore']);
...
//         $this->assertNotEmpty($this->export->props['source']);
        ...
        $this->assertNotEmpty(PHPUnit_Framework_Assert::readAttribute($this->export, 'targetRoot'));
...
//        $this->assertTrue($v === true || $v === false || $v === '1' || $v === '0' || $v === 1 || $v === 0);
    ...
    public function testProcessElements($element) {
        ...
        $elements = $this->mc->props['elements'][$type];
    ...
    public function testProcessSystemSettings() {
        ...
        //$this->utHelpers->createNewSystemSettings($this->modx, $this->mc);
