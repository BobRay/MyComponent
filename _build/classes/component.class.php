...
{   $modx;
    ...
    function __construct(&$modx, $name, $path)
    {//Get MODx first
        $this->modx =& $modx;
        $this->name = $name;
...
/*
 * Loads the config.php from the Package Folder.
 */
    function loadConfig()
    {
 ...
 */
    ...
    {//Begin tracking the time to build
        ...
        $builder->createPackage(PKG_CATEGORY, PKG_VERSION, PKG_RELEASE);
