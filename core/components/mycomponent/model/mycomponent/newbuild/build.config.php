...
$components = array(
    ...
    'packageName' => 'AJAX Revolution',
    'packageNameLower' => 'ajaxrevolution',
    'version' => '1.0.8',
    'release' => 'rc-1',
    'category' => 'AJAX Revolution', /* usually the same as the package name */
    'author' => 'Donald Atkinson (aka Fuzzical Logic)',
    'email' => 'fuzzicallogic@gmail.com',
    'authorUrl' => 'http://projects.extendeddialog.com/extended-dialog/ajax-revolution/',
    'authorSiteName' => "AJAX Revolution Development Blog",
    ...
    'packageDescription' => 'AJAX Framework for MODx Revolution 2+. Creates the Plugins necessary for configurable, gracefully degradable SEO AJAX with URL Parameters. This package includes three plugins and some utility Snippets.',
    'gitHubUsername' => 'FuzzicalLogic',
    'gitHubRepository' => 'https://github.com/FuzzicalLogic/AJAX-Revolution',

    /* Array containing the actual Element Names used in your extra */
    'elements' => array(
        //'modSnippet' => 'sendToTemplate',
        'modPlugin' => 'OnGetRequestType,OnParseURLParameters,OnNoCustomAliasFound,OnDegradeGracefully',
        //'modTemplateVar' => 'Tv1,Tv2',
        'modTemplate' => 'AJAX Partial HTML',
        'modChunk' => 'lazyLoader',
        'modSnippet' => 'getURLParameters'
    ),
...
* MyComponent will use yours instead of the default */
    ...
    'resolvers' => 'default,fixLoadOrder',
    ...
    'validators' => 'default', //'default,hasGdLib',
    ...
    * Will not overwrite existing files */
    ...
    'pluginEvents' => array(
        'OnGetRequestType' => 'OnPageNotFound',
        'OnParseURLParameters' => 'OnPageNotFound',
        'OnDegradeGracefully' => 'OnLoadWebDocument,OnLoadWebPageCache',
        'OnNoCustomAliasFound' => 'OnPageNotFound'
    ),
    ...
    */
    'process' => 'snippets,plugins,templates,chunks,propertySets,SystemSettings',
    'pagetitles' => '', // Comma-separated list of pagetitles of resources to process.
    ...
    'newSystemSettings' => array(
        'degrade_to_template' => array(
            'xtype' => 'template',
            'value' => 1
        ),
        'alias_ajax_page' => array(
            'xtype' => 'textField',
            'value' => 'ajax'
        ),
        'alias_degrade' => array(
